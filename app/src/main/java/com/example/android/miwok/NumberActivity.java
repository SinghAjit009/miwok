...
public class NumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("five", "massukka",R.drawable.number_five));
...
//        Log.v("NumbersActivity","number at index 0: "+numbers_e.get(0));
//        Log.v("NumbersActivity","number at index 1: "+numbers_e.get(1));
